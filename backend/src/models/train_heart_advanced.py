...
print("="*70)
print("HEALTHSCOPE - ADVANCED MODEL TRAINING: HEART DISEASE")
print("="*70)
...
baseline_results = pd.read_csv('models_saved/heart_baseline_results.csv')
...
if best_model_name == 'Random Forest':
    ...
    # Load baseline model
    best_model = joblib.load('models_saved/heart_baseline_lr.pkl')
...
# Save best model
best_model_path = 'models_saved/heart_model.pkl'
joblib.dump(best_model, best_model_path)
print(f"✓ Best model saved to: {best_model_path}")

# Save Random Forest
rf_path = 'models_saved/heart_rf.pkl'
joblib.dump(rf_model, rf_path)
print(f"✓ Random Forest saved to: {rf_path}")

# Save XGBoost
xgb_path = 'models_saved/heart_xgb.pkl'
...
results_path = 'models_saved/heart_all_models_results.csv'
...
# ============================================================================
print("\n" + "="*70)
print("ADVANCED MODEL TRAINING SUMMARY - HEART DISEASE")
print("="*70)
print(f"Best Model: {best_model_name}")
print(f"Best ROC-AUC: {best_roc_auc:.4f}")
print(f"\nAll models saved to: models_saved/")
print(f"  - heart_model.pkl (best model)")
print(f"  - heart_baseline_lr.pkl")
print(f"  - heart_rf.pkl")
print(f"  - heart_xgb.pkl")
print("="*70)

print("\n✓ Heart disease advanced model training complete!")
